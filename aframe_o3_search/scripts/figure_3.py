...
def main(
    ...
    scatter = axes[0].scatter(catalog.chirp_mass_source, catalog.network_matched_filter_snr, c=catalog.aframe_p_astro, cmap=cmap)
    ...
    scatter = axes[1].scatter(catalog.mass_1_source, catalog.mass_2_source, c=catalog.aframe_p_astro, cmap=cmap)
    ...
    plt.savefig(outdir / "figures" / "figure3.pdf", dpi=350, bbox_inches="tight")
    plt.show()
